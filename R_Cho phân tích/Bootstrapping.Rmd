...
Một cách để tính khoảng tin cậy cho một tỷ lệ quần thể là dựa trên Định lý Giới hạn Trung tâm (Central Limit Theorem), $\hat{p} \pm z^\star SE_{\hat{p}}$, hay chính xác hơn là
