...
###Khánh
Mục đích của công việc phân tích này là tìm hiểu xem liệu có mối quan hệ đáng kể nào giữa giới tính, thu nhập của cha mẹ, trình độ học vấn của cha mẹ và điểm kiểm tra hay không.
...
Đặt giả thuyết 
  H0: có sự khác biệt về kết quả học tập của sinh viên theo môn học theo giới tính 
  H1: không có sự khác biệt về kết quả học tập của sinh viên theo môn học theo giới tính 
...
Trong cả ba trường hợp, giá trị p rất nhỏ nên giả thuyết không có thể bị bác bỏ.

Vì vậy, có thể thấy sự khác biệt về kết quả học tập của sinh viên theo môn học theo giới tính là một sự khác biệt đáng kể.
...
```
  Vì giá trị p của kết quả Kiểm tra F < 0,05 nên giả thuyết H0 có thể bị bác bỏ. Do đó, có thể thấy phương sai của hai nhóm là khác nhau.
...
VARIABLE IMPORTANCE
```{r}
student_T <- Student_train %>% select(-m.score, -r.score, -w.score) # tạo bộ dữ liệu TRain student_T loại các biến điểm toán đọc viết
...
Câu hỏi: Mục đích của phân tích này là xem liệu có thể dự đoán được tổng điểm của học sinh qua các biến gender, test_preparation_course, reading_score và writing_score
...
Câu hỏi 1: Mục đích của phân tích này là xem liệu có mối quan hệ đáng kể nào giữa dân tộc, trình độ học vấn của cha mẹ với điểm kiểm tra hay không?
