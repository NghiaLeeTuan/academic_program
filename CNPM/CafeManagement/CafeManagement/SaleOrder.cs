...
namespace CafeManagement
{
    public partial class SaleOrder : Form
    {
        ...
        public SaleOrder(String id, String name)
        {
            InitializeComponent();
            this.id  = id;
            this.name = name;
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            db_HoaDon.ThemHoaDon(txtSDT.Text, id, double.Parse(txtTamTinh.Text), double.Parse(txtGiamGia.Text));
