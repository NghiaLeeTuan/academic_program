...
def main():
    ...
    # Read labels ###########################################################
    with open('C:/Users/user/Documents/Cánhân/XLA/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    with open(
            'C:/Users/user/Documents/Cánhân/XLA/model/keypoint_classifier/keypoint_classifier_label.csv',
            encoding='utf-8-sig') as f:
