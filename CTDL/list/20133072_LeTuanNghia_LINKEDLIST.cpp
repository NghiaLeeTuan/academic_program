...
{	
	...
	cout<< setw(5)<< left<<"|STT"<<setw(10)<< left<<"|MSSV"<<setw(16)<<left<<"|Ho va"<<setw(10)<<left<<"Ten"<<setw(15)<<left<<"|Gioi tinh"<<setw(12)<<left<<"|Ngay sinh"<<setw(10)<<left<<"|Diem Toan"<<setw(10) << left<< "|Diem Ly"<<setw(10) << left<<"|Diem hoa"<< setw(10) << left<<"|Diem TB"<<"|"<<"\n";
    Node *pTmp=list->pHead;
    if(pTmp==NULL)
    {
        cout<<"Danh sach rong";
    ...
    while(pTmp!=NULL)
    {
        ...
        cout<<"|"<<setw(4)<<left<<i<<"|"<<setw(9)<< left<<sv->mssv<<"|"<<setw(15)<< left<<sv->ho<<setw(10)<<left<<sv->ten<<"|"<<setw(14)<<left<<sv->sex<<"|"<<setw(2)<<left<<sv->ngay<<"/"<<setw(2)<<left<<sv->thang<<"/"<<setw(5)<<left<<sv->nam<<"|"<<setw(9)<<left<<sv->dtoan<<"|"<<setw(9) << left<< sv->dly<<"|"<<setw(9) << left<<sv->dhoa<<"|" <<setw(9) << left<<sv->dtb<<"|"<<"\n";
        pTmp=pTmp->pNext;
        i++;
    }
    cout<<"_____________________________________________________________________________________________________________\n";
    ...
    for(Node *pTmp=list->pHead;pTmp!=NULL;pTmp=pTmp->pNext)
    {
        ...
        {   
            ...
            if(svTmp2->dtb>svTmp->dtb)
            {
                ...
                float h=svTmp->dhoa;
                float tb=svTmp->dtb;
                ten.replace(0,10,svTmp->ten);
                ho.replace(0,30,svTmp->ho);
                sex.replace(0,5,svTmp->sex);
                ...
                svTmp->ten.replace(0,10,svTmp2->ten);
                svTmp->sex.replace(0,5,svTmp2->sex);
                svTmp->ho.replace(0,30,svTmp2->ho);
                ...
                svTmp2->thang=m;
                svTmp2->nam=y;
                svTmp2->ten.replace(0,10,ten);  
                svTmp2->sex.replace(0,5,sex);
                svTmp2->ho.replace(0,30,ho);           
            }
        }   
    }
}
    ...
    for(Node *pTmp=list->pHead;pTmp!=NULL;pTmp=pTmp->pNext)
    {
        ...
        {   
            ...
            if(svTmp2->mssv<svTmp->mssv)
            {
                ...
                float tb=svTmp->dtb;
                ten.replace(0,10,svTmp->ten);
                ho.replace(0,10,svTmp->ho);
                sex.replace(0,10,svTmp->sex);
...
//xuat file
void xuatfile(SingleList *&list,ofstream& fileout)
{
	int i=1;
	fileout<<"_____________________________________________________________________________________________________________\n";
	fileout<< setw(5)<< left<<"|STT"<<setw(10)<< left<<"|MSSV"<<setw(16)<<left<<"|Ho va"<<setw(10)<<left<<"Ten"<<setw(15)<<left<<"|Gioi tinh"<<setw(12)<<left<<"|Ngay sinh"<<setw(10)<<left<<"|Diem Toan"<<setw(10) << left<< "|Diem Ly"<<setw(10) << left<<"|Diem hoa"<< setw(10) << left<<"|Diem TB"<<"|"<<"\n";
    Node *pTmp=list->pHead;
    if(pTmp==NULL)
    {
    ...
    {
        SinhVien *sv=pTmp->data;
        fileout<<"|"<<setw(4)<<left<<i<<"|"<<setw(9)<< left<<sv->mssv<<"|"<<setw(15)<< left<<sv->ho<<setw(10)<<left<<sv->ten<<"|"<<setw(14)<<left<<sv->sex<<"|"<<setw(2)<<left<<sv->ngay<<"/"<<setw(2)<<left<<sv->thang<<"/"<<setw(5)<<left<<sv->nam<<"|"<<setw(9)<<left<<sv->dtoan<<"|"<<setw(9) << left<< sv->dly<<"|"<<setw(9) << left<<sv->dhoa<<"|" <<setw(9) << left<<sv->dtb<<"|"<<"\n";
        pTmp=pTmp->pNext;
        i++;
    }
    fileout<<"_____________________________________________________________________________________________________________\n";
    cout<<"Da xuat file output.txt!!!";
}


//doc file
SinhVien *doc(SingleList *&list,ifstream& file)
{
...
int main(int argc, char** argv) {
	...
	do{
		...
		PrintList(list);}
		else if(c==6){			system("cls");	
		Sort(list);}
		else if(c==7){			system("cls");
		std::ifstream file;
		file.open("Danhsach.txt", ios_base::in);
		if(file.fail()==true)
		{	
