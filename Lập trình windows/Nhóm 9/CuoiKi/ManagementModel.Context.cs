...
public partial class ManagementDFContext : DbContext
{
    ...
    [DbFunction("ManagementDFContext", "Doanhthu_tung_thang1")]
    public virtual IQueryable<Doanhthu_tung_thang1_Result> Doanhthu_tung_thang1(Nullable<int> year, Nullable<int> month)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Doanhthu_tung_thang1_Result>("[ManagementDFContext].[Doanhthu_tung_thang1](@year, @month)", yearParameter, monthParameter);
    }
    ...
    [DbFunction("ManagementDFContext", "Doanhthu_tung_thang2")]
    public virtual IQueryable<Doanhthu_tung_thang2_Result> Doanhthu_tung_thang2(Nullable<int> year, Nullable<int> month)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Doanhthu_tung_thang2_Result>("[ManagementDFContext].[Doanhthu_tung_thang2](@year, @month)", yearParameter, monthParameter);
    }
