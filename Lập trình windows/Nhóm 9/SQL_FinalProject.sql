...
Insert into dbo.Customers values(1,N'Nguyễn Quốc Vinh',N'1 Tô Ngọc Vân',900000)
Insert into dbo.Customers values(2,N'Trần Lê Ngọc Gia Hân',N'2 Tô Ngọc Vân',100000)
Insert into dbo.Customers values(3,N'Lê Gia Hân',N'3 Tô Ngọc Vân',80000)
Insert into dbo.Customers values(4,N'Nguyễn Thị Lan Anh',N'4 Tô Ngọc Vân',170000)
Insert into dbo.Customers values(5,N'Nguyễn Thị Phương Anh',N'5 Tô Ngọc Vân',2090000)
Insert into dbo.Customers values(6,N'Diệp Tấn Luân',N'6 Tô Ngọc Vân',1000000)
Insert into dbo.Customers values(7,N'Bùi Quốc Tĩnh',N'7 Tô Ngọc Vân',800000)
Insert into dbo.Customers values(8,N'Đỗ Thị Mỹ Lan',N'8 Tô Ngọc Vân',203000)
Insert into dbo.Customers values(9,N'Bùi Tấn Đạt',N'9 Tô Ngọc Vân',256000)
Insert into dbo.Customers values(10,N'Nguyễn Ý',N'10 Tô Ngọc Vân',1516000)
Insert into dbo.Customers values(11,N'Trần Thị Mỹ Huyền',N'11 Tô Ngọc Vân',915000)
Insert into dbo.Customers values(12,N'Nguyễn Hải Quốc Bảo',N'12 Tô Ngọc Vân',812000)
Insert into dbo.Customers values(13,N'Lê Thành Nhân',N'13 Tô Ngọc Vân',941000)
Insert into dbo.Customers values(14,N'Lê Thanh Sang',N'14 Tô Ngọc Vân',661000)
Insert into dbo.Customers values(15,N'Lê Thị Phượng',N'15 Tô Ngọc Vân',612000)
Insert into dbo.Customers values(16,N'Lê Văn Săm',N'16 Tô Ngọc Vân',735000)
Insert into dbo.Customers values(17,N'Văn Thị Mười Ngọc',N'17 Tô Ngọc Vân',373000)
Insert into dbo.Customers values(18,N'Nguyễn Kim Ngân',N'18 Tô Ngọc Vân',241000)
Insert into dbo.Customers values(19,N'Nguyễn Thị Thùy Trang',N'19 Tô Ngọc Vân',345000)
Insert into dbo.Customers values(20,N'Phùng Thị Thùy Trang',N'20 Tô Ngọc Vân',823000)
Insert into dbo.Customers values(21,N'Huỳnh Ngọc Trâm',N'21 Tô Ngọc Vân',612000)
Insert into dbo.Customers values(22,N'Nguyễn Hồng Điệp',N'22 Tô Ngọc Vân',843000)
Insert into dbo.Customers values(23,N'Trần Ngọc Phước',N'23 Tô Ngọc Vân',1562000)
Insert into dbo.Customers values(24,N'Nguyễn Hải Bích Phượng',N'24 Tô Ngọc Vân',512000)
Insert into dbo.Customers values(25,N'Nguyễn Bảo Yến',N'25 Tô Ngọc Vân',671000)
Insert into dbo.Customers values(26,N'Võ Như Ý',N'26 Tô Ngọc Vân',612000)
Insert into dbo.Customers values(27,N'Nguyễn Chí Dũng',N'27 Tô Ngọc Vân',685000)
Insert into dbo.Customers values(28,N'Hải Triều Châu',N'28 Tô Ngọc Vân',832000)
Insert into dbo.Customers values(29,N'Trương Võ Song Toàn',N'29 Tô Ngọc Vân',645000)
Insert into dbo.Customers values(30,N'Lê Gia Huy',N'30 Tô Ngọc Vân',582000)
...
insert into dbo.Item values (N'Nước mắm', 5900, 8000, 8,'12/30/2021')
insert into dbo.Item values (N'Nước tương',7000, 12000, 5000,'12/30/2022')
insert into dbo.Item values (N'Dầu ăn',6000, 10000, 5000,'12/30/2021')
...
insert into dbo.Item values (N'Bánh Snack khoai tây',6900,12000,1500,'12/30/2021')
insert into dbo.Item values (N'Bánh Snack rong biển',6900,12000,1500,'12/30/2022')
insert into dbo.Item values (N'Bánh Snack vị gà quay',6900,12000,2,'12/30/2022')
...
insert into dbo.Item values (N'Thẻ điện thoại 50k',48000,50000,5,'12/30/2021')
insert into dbo.Item values (N'Thẻ điện thoại 100k',97000,100000,1000,'12/30/2022')
insert into dbo.Item values (N'Mì 3 miền',2100,3500,2000,'10/30/2021')
...
insert into dbo.Item values (N'Mì Đệ nhất',3000,5000,2000,'10/30/2020')
insert into dbo.Item values (N'Mì Gấu đỏ',2100,3500,4,'10/30/2022')
...
insert into dbo.Item values (N'Kẹo Trái cây 4 mùa',6200,13000,2000,'12/30/2021')
...
insert into dbo.Item values (N'Bánh Solite',2200,3000,3,'12/30/2022')
...
insert into dbo.Orders values('4/27/2022 13:25:54',16,1,0)
insert into dbo.Lineitem values(16,1,2)
insert into dbo.Lineitem values(16,2,1)
insert into dbo.Lineitem values(16,3,3)
insert into dbo.Lineitem values(16,10,3)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =16) where order_id =16
	
insert into dbo.Orders values('4/15/2022 14:10:24',17,4,0)
insert into dbo.Lineitem values(17,12,1)
insert into dbo.Lineitem values(17,14,2)
insert into dbo.Lineitem values(17,15,2)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =17) where order_id =17

insert into dbo.Orders values('4/10/2022 12:14:25',18,7,0)
insert into dbo.Lineitem values(18,35,2)
insert into dbo.Lineitem values(18,38,2)
insert into dbo.Lineitem values(18,45,3)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =18) where order_id =18

insert into dbo.Orders values('10/27/2021 9:22:15',19,3,0)
insert into dbo.Lineitem values(19,49,2)
insert into dbo.Lineitem values(19,42,1)
insert into dbo.Lineitem values(19,14,3)
insert into dbo.Lineitem values(19,15,1)
insert into dbo.Lineitem values(19,18,2)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =19) where order_id =19

insert into dbo.Orders values('5/27/2021 12:15:23',20,2,0)
insert into dbo.Lineitem values(20,26,4)
insert into dbo.Lineitem values(20,28,1)
insert into dbo.Lineitem values(20,33,3)
insert into dbo.Lineitem values(20,34,1)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =20) where order_id =20

insert into dbo.Orders values('7/7/2021 12:23:21',21,8,0)
insert into dbo.Lineitem values(21,42,3)
insert into dbo.Lineitem values(21,38,2)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =21) where order_id =21

insert into dbo.Orders values('8/24/2021 18:13:23',22,6,0)
insert into dbo.Lineitem values(22,16,4)
insert into dbo.Lineitem values(22,37,2)
insert into dbo.Lineitem values(22,19,1)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =22) where order_id =22

insert into dbo.Orders values('9/3/2021 15:21:24',23,8,0)
insert into dbo.Lineitem values(23,26,4)
insert into dbo.Lineitem values(23,23,1)
insert into dbo.Lineitem values(23,19,3)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =23) where order_id =23

insert into dbo.Orders values('10/11/2021 12:26:54',24,2,0)
insert into dbo.Lineitem values(24,20,2)
insert into dbo.Lineitem values(24,18,1)
insert into dbo.Lineitem values(24,29,2)
insert into dbo.Lineitem values(24,17,3)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =24) where order_id =24

insert into dbo.Orders values('12/17/2021 13:25:54',25,5,0)
insert into dbo.Lineitem values(25,2,3)
insert into dbo.Lineitem values(25,12,3)
insert into dbo.Lineitem values(25,4,2)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =25) where order_id =25

insert into dbo.Orders values('6/5/2020 9:51:20',26,2,0)
insert into dbo.Lineitem values(26,25,2)
insert into dbo.Lineitem values(26,28,3)
insert into dbo.Lineitem values(26,49,1)
insert into dbo.Lineitem values(26,50,3)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =26) where order_id =26

insert into dbo.Orders values('7/19/2020 15:23:42',27,3,0)
insert into dbo.Lineitem values(27,48,2)
insert into dbo.Lineitem values(27,45,3)
insert into dbo.Lineitem values(27,32,1)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =27) where order_id =27

insert into dbo.Orders values('10/25/2020 11:12:10',28,8,0)
insert into dbo.Lineitem values(28,14,3)
insert into dbo.Lineitem values(28,15,1)
insert into dbo.Lineitem values(28,18,3)
insert into dbo.Lineitem values(28,44,2)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =28) where order_id =28

insert into dbo.Orders values('11/14/2020 7:34:02',29,9,0)
insert into dbo.Lineitem values(29,11,2)
insert into dbo.Lineitem values(29,43,3)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =29) where order_id =29

insert into dbo.Orders values('12/23/2020 10:22:08',30,2,0)
insert into dbo.Lineitem values(30,15,3)
insert into dbo.Lineitem values(30,17,2)
insert into dbo.Lineitem values(30,26,1)
insert into dbo.Lineitem values(30,28,2)
insert into dbo.Lineitem values(30,39,2)
update dbo.Orders Set total = (select sum(Item.item_price_out*Lineitem.quantity) 
	from Item,Lineitem,Orders 
	Where Lineitem.order_id = Orders.order_id And Lineitem.item_id=Item.item_id and Orders.order_id =30) where order_id =30
