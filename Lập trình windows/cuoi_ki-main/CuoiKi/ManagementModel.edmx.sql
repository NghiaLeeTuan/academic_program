...
-- --------------------------------------------------
-- Date Created: 06/01/2022 23:04:36
-- Generated from EDMX file: D:\Môn học\cuoi_ki-main\CuoiKi\ManagementModel.edmx
-- --------------------------------------------------
...
ALTER TABLE [dbo].[Employees]
ADD CONSTRAINT [FK__Employee__employ__2E1BDC42]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Employee__employ__2E1BDC42'
CREATE INDEX [IX_FK__Employee__employ__2E1BDC42]
ON [dbo].[Employees]
    ([employee_account]);
GO
...
ALTER TABLE [dbo].[Orders]
ADD CONSTRAINT [FK__Orders__customer__38996AB5]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Orders__customer__38996AB5'
CREATE INDEX [IX_FK__Orders__customer__38996AB5]
ON [dbo].[Orders]
    ([customer_id]);
GO
...
ALTER TABLE [dbo].[Orders]
ADD CONSTRAINT [FK__Orders__employee__300424B4]
...
-- Creating non-clustered index for FOREIGN KEY 'FK__Orders__employee__300424B4'
CREATE INDEX [IX_FK__Orders__employee__300424B4]
ON [dbo].[Orders]
    ([employee_id]);
GO
...
ALTER TABLE [dbo].[Lineitems]
ADD CONSTRAINT [FK__Lineitem__order___30F848ED]
